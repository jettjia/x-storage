...
/*     */ @XmlType(name = "cmisPropertyDateTimeDefinitionType", namespace = "http://docs.oasis-open.org/ns/cmis/core/200908/", propOrder = {"defaultValue", "resolution", "choice"})
...
/* 120 */     if (this.choice == null) {
/* 121 */       this.choice = new ArrayList<>();
/*     */     }
/* 123 */     return this.choice;
/*     */   }
/*     */ }


/* Location:              E:\web\java_work\jd-gui-windows-1.6.6\chemistry-opencmis-commons-impl-1.1.0.jar!\org\apache\chemistry\opencmis\commons\impl\jaxb\CmisPropertyDateTimeDefinitionType.class
