...
/*     */ @XmlType(name = "cmisRenditionType", namespace = "http://docs.oasis-open.org/ns/cmis/core/200908/", propOrder = {"streamId", "mimetype", "length", "kind", "title", "height", "width", "renditionDocumentId", "any"})
...
/* 248 */     return this.renditionDocumentId;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 287 */     if (this.any == null) {
/* 288 */       this.any = new ArrayList();
/*     */     }
/* 290 */     return this.any;
/*     */   }
/*     */ }
...
/* Location:              E:\web\java_work\jd-gui-windows-1.6.6\chemistry-opencmis-commons-impl-1.1.0.jar!\org\apache\chemistry\opencmis\commons\impl\jaxb\CmisRenditionType.class
